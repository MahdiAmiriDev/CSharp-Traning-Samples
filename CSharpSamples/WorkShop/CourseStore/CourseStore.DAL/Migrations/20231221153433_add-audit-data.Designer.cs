...
namespace CourseStore.DAL.Migrations
{
    ...
    [Migration("20231221153433_add-audit-data")]
    partial class addauditdata
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseStore.Model.CourseTag.Entites.CourseTags", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseStore.Model.CourseTag.Entites.CourseTags", b =>
                {
                    ...
                    b.HasOne("CourseStore.Model.Tags.Entities.Tag", "Tags")
                        .WithMany("CourseTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
