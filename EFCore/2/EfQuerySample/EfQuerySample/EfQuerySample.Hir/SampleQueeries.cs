...
{
    public class SampleQueeries
    {
        private readonly EmpContext _empContext;

        public SampleQueeries(EmpContext empContext)
        {
            ...
            for (int i = start; i < count; i++)
            {
                ...
                for (int j = start; j < count; j++)
                {
                    ...
                    for (int k = start; k < count; k++)
                    {
                        ...
                        type02.Type03.Add(type03);
                    }
                    type01.Type02.Add(type02);
                }
